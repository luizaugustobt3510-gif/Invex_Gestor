      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/controle-validades" element={<RoleProtectedRoute allowedRoles={['admin', 'logistica', 'usuario almox']} moduleKey="logistica" submoduleKey="logistica.estoque"><ControleValidades /></RoleProtectedRoute>} />
            ...
            <Route path="/estoque-setores" element={<RoleProtectedRoute allowedRoles={['admin', 'logistica', 'usuario almox', 'enfermagem', 'enfermeiro', 'clinica']} moduleKey="logistica" submoduleKey="logistica.estoque_setores"><EstoqueSetores /></RoleProtectedRoute>} />



            {/* === SOLICITAÇÕES === */}
            <Route path="/solicitar-material" element={<RoleProtectedRoute allowedRoles={['admin', 'logistica', 'usuario almox', 'solicitante', 'enfermagem', 'enfermeiro', 'recepcionista', 'clinica']} moduleKey="solicitacao_materiais"><SolicitarMaterial /></RoleProtectedRoute>} />
            ...
            <Route path="/clinica/pacientes" element={<RoleProtectedRoute allowedRoles={['admin', 'clinica', 'rh', 'visualizador', 'enfermagem', 'enfermeiro', 'recepcionista']} moduleKey="prontuario"><Pacientes /></RoleProtectedRoute>} />
            <Route path="/clinica/pacientes/:id" element={<RoleProtectedRoute allowedRoles={['admin', 'clinica', 'rh', 'visualizador', 'enfermagem', 'enfermeiro', 'recepcionista']} moduleKey="prontuario"><PacienteProntuario /></RoleProtectedRoute>} />
            <Route path="/clinica/agenda" element={<RoleProtectedRoute allowedRoles={['admin', 'clinica', 'rh', 'visualizador', 'enfermagem', 'enfermeiro', 'recepcionista']} moduleKey="agenda"><Agenda /></RoleProtectedRoute>} />
            <Route path="/clinica/anamnese/modelos" element={<RoleProtectedRoute allowedRoles={['admin', 'clinica', 'enfermagem', 'enfermeiro']} moduleKey="anamnese"><AnamneseModelos /></RoleProtectedRoute>} />
            ...
            <Route path="/clinica/receituario" element={<RoleProtectedRoute allowedRoles={['admin', 'clinica', 'enfermagem', 'enfermeiro', 'recepcionista']} moduleKey="receituario"><Receituario /></RoleProtectedRoute>} />
            <Route path="/clinica/receituario/rapidas" element={<RoleProtectedRoute allowedRoles={['admin', 'clinica', 'enfermagem', 'enfermeiro', 'recepcionista']} moduleKey="receituario"><PrescricaoRapidas /></RoleProtectedRoute>} />
            <Route path="/clinica/receituario/:patientId" element={<RoleProtectedRoute allowedRoles={['admin', 'clinica', 'enfermagem', 'enfermeiro', 'recepcionista']} moduleKey="receituario"><Receituario /></RoleProtectedRoute>} />
