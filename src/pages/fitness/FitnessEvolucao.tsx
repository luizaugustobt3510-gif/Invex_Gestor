...
const FitnessEvolucao = () => (
  <FitnessLayout>
    <h1 className="text-2xl font-black mb-1">Evolução</h1>
    <p className="text-sm text-slate-400 mb-4">Medidas, peso e fotos</p>

    <FitnessCard className="text-center py-10">
      <TrendingUp className="w-12 h-12 mx-auto text-fuchsia-400 mb-3" />
      <h2 className="text-lg font-bold mb-2">Em construção</h2>
      <p className="text-sm text-slate-400 max-w-xs mx-auto">
        Gráficos de evolução, medidas corporais e galeria de fotos chegam em breve.
      </p>
